...
(:transitions
	...
	(n25  n24  (:goal (and (at person2 city6))))
	(n24  n23  (:goal (and (at plane2 city2)(at person1 city1)(at person4 city5)(at person7 city1))))
	(n23  n22  (:goal (and (at person3 city6)(at person4 city4)(at person6 city4))))
	(n22  n21  (:goal (and (at person6 city3)(at person7 city3))))
	(n21  n20  (:goal (and (at person2 city4)(at person7 city5))))
	(n20  n19  (:goal (and (at person1 city4)(at person2 city4)(at person8 city3))))
	(n19  n18  (:goal (and (at person8 city1))))
	(n18  n17  (:goal (and (at person2 city0)(at person7 city1))))
	(n17  n16  (:goal (and (at person1 city6)(at person4 city0)(at person6 city4))))
	(n16  n15  (:goal (and (at person8 city1))))
	(n15  n14  (:goal (and (at person3 city0)(at person4 city0)(at person6 city3))))
	(n14  n13  (:goal (and (at person1 city4)(at person7 city0)(at person8 city6))))
	(n13  n12  (:goal (and (at person8 city2))))
	(n12  n11  (:goal (and (at person4 city2)(at person5 city5)(at person7 city0))))
	(n11  n10  (:goal (and (at person1 city2)(at person4 city6))))
	(n10  n9  (:goal (and (at person1 city3)(at person3 city1)(at person4 city2))))
	(n9  n8  (:goal (and (at person2 city4)(at person5 city2))))
	(n8  n7  (:goal (and (at person3 city6)(at person4 city6)(at person6 city0))))
	(n7  n6  (:goal (and (at person1 city3)(at person8 city3))))
	(n6  n5  (:goal (and (at plane2 city5)(at person2 city2)(at person4 city4))))
	(n5  n4  (:goal (and (at person6 city5)(at person7 city3))))
	(n4  n3  (:goal (and (at plane1 city3)(at person8 city3))))
	(n3  n2  (:goal (and (at person1 city4)(at person3 city4)(at person4 city2))))
	(n2  n1  (:goal (and (at person3 city1)(at person4 city5))))
	(n1  n0  (:goal (and (at person8 city0))))
)
)
