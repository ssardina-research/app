...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (is-parked airplane_HOLGI seg_B02_0_100))))
	(n1  n2  (:goal (and (airborne airplane_DFBOY seg_09_0_150))))
	(n2  n3  (:goal (and (is-parked airplane_CFBEG seg_A01_0_100))))
	(n3  n4  (:goal (and (airborne airplane_WURST seg_09_0_150))))
	(n4  n5  (:goal (and (airborne airplane_HORST seg_09_0_150))))
	(n5  n6  (:goal (and (airborne airplane_DAEWH seg_09_0_150))))
)
)
