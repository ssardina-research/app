...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (is-parked airplane_CFBEG seg_A02_0_100))))
	(n1  n2  (:goal (and (is-parked airplane_HOLGI seg_B02_0_100))))
	(n2  n3  (:goal (and (airborne airplane_DFBOY seg_09_0_150))))
	(n3  n4  (:goal (and (airborne airplane_DAEWH seg_09_0_150))))
)
)
