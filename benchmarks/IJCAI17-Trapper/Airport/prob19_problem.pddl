...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (airborne airplane_DAEW6 seg_08l_0_80))))
	(n1  n2  (:goal (and (is-parked airplane_CFBEG seg_p104_0_76))))
	(n2  n3  (:goal (and (is-parked airplane_4XEKD seg_p112_0_76))))
	(n3  n4  (:goal (and (airborne airplane_DAEW5 seg_08l_0_80))))
	(n4  n5  (:goal (and (airborne airplane_DAEWH seg_08l_0_80))))
	(n5  n6  (:goal (and (is-parked airplane_CFBE1 seg_p101_0_76))))
)
)
