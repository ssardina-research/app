...
(:transitions
	...
	(n1  n2  (:goal (and (airborne airplane_DAEW6 seg_08l_0_80))))
	(n2  n3  (:goal (and (airborne airplane_DAEW7 seg_08l_0_80))))
	(n3  n4  (:goal (and (is-parked airplane_CFBEG seg_p104_0_76))))
)
)
