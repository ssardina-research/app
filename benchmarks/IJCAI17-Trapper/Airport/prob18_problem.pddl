...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (airborne airplane_DAEW7 seg_08l_0_80))))
	(n1  n2  (:goal (and (is-parked airplane_CFBE1 seg_p101_0_76))))
	(n2  n3  (:goal (and (airborne airplane_DAEW3 seg_08l_0_80))))
	(n3  n4  (:goal (and (airborne airplane_DAEWH seg_08l_0_80))))
	(n4  n5  (:goal (and (is-parked airplane_CFBEG seg_p104_0_76))))
)
)
