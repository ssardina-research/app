...
(:transitions
	...
	(n1  n2  (:goal (and (painted tile_2-1 black))))
	(n2  n3  (:goal (and (painted tile_1-1 black))))
	(n3  n4  (:goal (and (painted tile_3-1 black))))
	(n4  n5  (:goal (and (painted tile_1-2 black))))
	(n5  n6  (:goal (and (painted tile_2-3 black))))
	(n6  n7  (:goal (and (painted tile_2-2 white))))
	(n7  n8  (:goal (and (painted tile_3-3 white))))
	(n8  n9  (:goal (and (painted tile_3-2 black))))
)
)
