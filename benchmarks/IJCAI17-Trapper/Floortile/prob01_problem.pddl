...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (painted tile_2-1 black)    (painted tile_2-2 white)    (painted tile_2-3 black))))
	(n1  n2  (:goal (and (painted tile_3-1 white)    (painted tile_3-2 black)    (painted tile_3-3 white))))
