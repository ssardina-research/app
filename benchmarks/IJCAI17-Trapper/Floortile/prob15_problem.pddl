...
(:transitions
	...
	(n3  n4  (:goal (and (painted tile_1-3 black))))
	(n4  n5  (:goal (and (painted tile_1-4 white))))
	(n5  n6  (:goal (and (painted tile_2-2 black))))
	(n6  n7  (:goal (and (painted tile_2-5 white))))
	(n7  n8  (:goal (and (painted tile_3-2 black))))
	(n8  n9  (:goal (and (painted tile_2-1 white))))
	(n9  n10  (:goal (and (painted tile_3-1 white))))
	(n10  n11  (:goal (and (painted tile_2-4 white))))
	(n11  n12  (:goal (and (painted tile_3-4 black))))
	(n12  n13  (:goal (and (painted tile_2-3 black))))
	(n13  n14  (:goal (and (painted tile_4-1 black))))
	(n14  n15  (:goal (and (painted tile_3-3 black))))
	(n15  n16  (:goal (and (painted tile_3-5 black))))
	(n16  n17  (:goal (and (painted tile_4-4 white))))
	(n17  n18  (:goal (and (painted tile_4-2 black))))
	(n18  n19  (:goal (and (painted tile_4-5 black))))
	(n19  n20  (:goal (and (painted tile_4-3 white))))
)
)
