...
(:transitions
	...
	(n1  n2  (:goal (and (painted tile_1-1 white) (painted tile_1-2 black)    (painted tile_1-3 white))))
	(n2  n3  (:goal (and (painted tile_2-1 black)    (painted tile_2-2 white)    (painted tile_2-3 black))))
)
)
