...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (painted tile_1-1 black))))
	(n1  n2  (:goal (and (painted tile_1-2 black))))
	(n2  n3  (:goal (and (painted tile_1-5 black))))
	(n3  n4  (:goal (and (painted tile_2-3 black))))
	(n4  n5  (:goal (and (painted tile_1-4 white))))
	(n5  n6  (:goal (and (painted tile_3-1 white))))
	(n6  n7  (:goal (and (painted tile_2-4 black))))
	(n7  n8  (:goal (and (painted tile_3-5 white))))
	(n8  n9  (:goal (and (painted tile_1-3 white))))
	(n9  n10  (:goal (and (painted tile_2-2 white))))
	(n10  n11  (:goal (and (painted tile_2-5 white))))
	(n11  n12  (:goal (and (painted tile_2-1 black))))
	(n12  n13  (:goal (and (painted tile_4-2 black))))
	(n13  n14  (:goal (and (painted tile_3-4 black))))
	(n14  n15  (:goal (and (painted tile_3-3 white))))
	(n15  n16  (:goal (and (painted tile_4-4 black))))
	(n16  n17  (:goal (and (painted tile_4-3 white))))
	(n17  n18  (:goal (and (painted tile_3-2 white))))
	(n18  n19  (:goal (and (painted tile_4-5 black))))
	(n19  n20  (:goal (and (painted tile_4-1 white))))
)
)
