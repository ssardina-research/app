...
(:transitions
	...
	(n1  n2  (:goal (and (painted tile_1-1 black))))
	(n2  n3  (:goal (and (painted tile_2-1 white))))
	(n3  n4  (:goal (and (painted tile_1-5 black))))
	(n4  n5  (:goal (and (painted tile_1-4 black))))
	(n5  n6  (:goal (and (painted tile_3-3 black))))
	(n6  n7  (:goal (and (painted tile_2-4 black))))
	(n7  n8  (:goal (and (painted tile_1-3 black))))
	(n8  n9  (:goal (and (painted tile_3-1 black))))
	(n9  n10  (:goal (and (painted tile_2-2 white))))
	(n10  n11  (:goal (and (painted tile_2-5 black))))
	(n11  n12  (:goal (and (painted tile_3-2 white))))
	(n12  n13  (:goal (and (painted tile_2-3 white))))
	(n13  n14  (:goal (and (painted tile_4-1 white))))
	(n14  n15  (:goal (and (painted tile_4-5 black))))
	(n15  n16  (:goal (and (painted tile_3-4 white))))
	(n16  n17  (:goal (and (painted tile_3-5 black))))
	(n17  n18  (:goal (and (painted tile_4-3 white))))
	(n18  n19  (:goal (and (painted tile_4-4 black))))
