...
(:transitions
	...
	(n1  n2  (:goal (and (on b6 b2))))
	(n2  n3  (:goal (and (on b3 b6))))
	(n0  n2  (:goal (and (on b5 b7))))
	(n2  n0  (:goal (and (on b1 b5) (on b5 b2))))
	(n3  n2  (:goal (and (on b6 b4))))
	(n1  n3  (:goal (and (on b3 b6) (on b8 b7))))
	(n0  n3  (:goal (and (on b7 b2) (on b8 b7))))
)
)
