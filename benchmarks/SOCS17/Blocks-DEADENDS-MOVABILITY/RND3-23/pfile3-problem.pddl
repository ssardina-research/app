...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (on b4 b8) (on b2 b4))))
	(n1  n2  (:goal (and (on b5 b8) (on b6 b4))))
	(n1  n0  (:goal (and (on b8 b5) (on b7 b1))))
	(n2  n1  (:goal (and (on b8 b4) (on b7 b1))))
	(n2  n0  (:goal (and (on b5 b4))))
)
)
