...
(:init-app n0)
(:transitions
	(n0  n1  (:goal (and (on b5 b4))))
	(n1  n2  (:goal (and (on b3 b6) (on b2 b1))))
	(n2  n3  (:goal (and (on b4 b3) (on b5 b6))))
	(n3  n2  (:goal (and (on b2 b6) (on b1 b5))))
	(n2  n1  (:goal (and (on b5 b7))))
	(n1  n0  (:goal (and (on b3 b7))))
)
)
