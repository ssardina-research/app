...
(:transitions
	...
	(n1  n2  (:goal (and (on b5 b7))))
	(n2  n3  (:goal (and (on b5 b3))))
	(n3  n4  (:goal (and (on b2 b1))))
	(n4  n5  (:goal (and (on b4 b3))))
	(n0  n6  (:goal (and (on b7 b1))))
	(n1  n6  (:goal (and (on b8 b4))))
	(n2  n6  (:goal (and (on b3 b5))))
	(n3  n6  (:goal (and (on b4 b8))))
	(n4  n6  (:goal (and (on b7 b8))))
