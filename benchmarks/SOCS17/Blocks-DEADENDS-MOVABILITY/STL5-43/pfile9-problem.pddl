...
(:transitions
	...
	(n4  n5  (:goal (and (on b6 b2))))
	(n5  n6  (:goal (and (on b5 b6))))
	(n6  n7  (:goal (and (on b3 b7))))
	(n0  n8  (:goal (and (on b7 b8))))
	(n1  n8  (:goal (and (on b4 b3))))
	(n2  n8  (:goal (and (on b1 b7))))
	(n3  n8  (:goal (and (on b7 b5))))
	(n4  n8  (:goal (and (on b3 b6))))
	(n5  n8  (:goal (and (on b5 b3))))
	(n6  n8  (:goal (and (on b7 b3))))
