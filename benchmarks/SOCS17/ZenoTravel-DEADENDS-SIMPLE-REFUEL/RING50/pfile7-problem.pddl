...
(:transitions
	...
	(n26  n27  (:goal (and (at plane2 city2) (at person3 city1) (at person5 city3) (at person6 city3))))
	(n27  n28  (:goal (and (at person2 city2) (at person4 city3))))
	(n28  n29  (:goal (and (at person1 city1) (at person2 city2) (at person4 city1))))
	(n29  n30  (:goal (and (at person6 city3))))
	(n30  n31  (:goal (and (at person1 city2))))
	(n31  n32  (:goal (and (at person1 city3) (at person3 city2) (at person4 city1))))
	(n32  n33  (:goal (and (at person2 city2) (at person3 city3))))
	(n33  n34  (:goal (and (at person3 city1) (at person4 city3))))
	(n34  n35  (:goal (and (at person2 city2) (at person3 city1))))
	(n35  n36  (:goal (and (at person6 city1))))
	(n36  n37  (:goal (and (at person2 city0) (at person3 city1) (at person6 city0))))
	(n37  n38  (:goal (and (at plane2 city1) (at person2 city1) (at person6 city2))))
	(n38  n39  (:goal (and (at person6 city1))))
	(n39  n40  (:goal (and (at person2 city1) (at person3 city2))))
	(n40  n41  (:goal (and (at plane1 city3) (at person1 city2) (at person4 city2) (at person6 city0))))
	(n41  n42  (:goal (and (at person1 city3) (at person4 city2))))
	(n42  n43  (:goal (and (at plane2 city2) (at person5 city3))))
	(n43  n44  (:goal (and (at plane1 city1) (at person3 city1) (at person6 city1))))
	(n44  n45  (:goal (and (at person5 city0) (at person6 city2))))
	(n45  n46  (:goal (and (at plane2 city1))))
	(n46  n47  (:goal (and (at person4 city0) (at person5 city2))))
	(n47  n48  (:goal (and (at person6 city3))))
	(n48  n49  (:goal (and (at person1 city1) (at person2 city2) (at person4 city2))))
	(n49  n0  (:goal (and (at person2 city2) (at person4 city3))))
)
)
