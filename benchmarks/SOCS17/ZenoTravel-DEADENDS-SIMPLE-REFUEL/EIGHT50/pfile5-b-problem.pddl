...
(:transitions
	...
	(n25  n24  (:goal (and (at person4 city0) (at person2 city3))))
	(n24  n23  (:goal (and (at person1 city2) (at person3 city1))))
	(n23  n22  (:goal (and (at person2 city0))))
	(n22  n21  (:goal (and (at person3 city1))))
	(n21  n20  (:goal (and (at person2 city1) (at person4 city1))))
	(n20  n19  (:goal (and (at person3 city2))))
	(n19  n18  (:goal (and (at person1 city2))))
	(n18  n17  (:goal (and (at person2 city0))))
	(n17  n16  (:goal (and (at person1 city0))))
	(n16  n15  (:goal (and (at person3 city1))))
	(n15  n14  (:goal (and (at person3 city3) (at person2 city1))))
	(n14  n13  (:goal (and (at person1 city3) (at person2 city1))))
	(n13  n12  (:goal (and (at person1 city3))))
	(n12  n11  (:goal (and (at person4 city1) (at person3 city0))))
	(n11  n10  (:goal (and (at person3 city0))))
	(n10  n9  (:goal (and (at person2 city0) (at person4 city0))))
	(n9  n8  (:goal (and (at person3 city2) (at person1 city3))))
	(n8  n7  (:goal (and (at person4 city3))))
	(n7  n6  (:goal (and (at person3 city0) (at person1 city1))))
	(n6  n5  (:goal (and (at person1 city0) (at person2 city0))))
	(n5  n4  (:goal (and (at person2 city3))))
	(n4  n3  (:goal (and (at person1 city2))))
	(n3  n2  (:goal (and (at person1 city1))))
	(n2  n1  (:goal (and (at person3 city1) (at person2 city1))))
	(n1  n0  (:goal (and (at person4 city0) (at person2 city3))))
)
)
