...
(:transitions
	...
	(n22  n21  (:goal (and (at person4 city0))))
	(n21  n20  (:goal (and (at person4 city1))))
	(n20  n19  (:goal (and (at person2 city0))))
	(n19  n18  (:goal (and (at person3 city0))))
	(n18  n17  (:goal (and (at person2 city1))))
	(n17  n16  (:goal (and (at person3 city2))))
	(n16  n15  (:goal (and (at person1 city1))))
	(n15  n14  (:goal (and (at person2 city2))))
	(n14  n13  (:goal (and (at person2 city0))))
	(n13  n12  (:goal (and (at person3 city1))))
	(n12  n11  (:goal (and (at person1 city0))))
	(n11  n10  (:goal (and (at person4 city1))))
	(n10  n9  (:goal (and (at person2 city1))))
	(n9  n8  (:goal (and (at person3 city0))))
	(n8  n7  (:goal (and (at person3 city2))))
	(n7  n6  (:goal (and (at person4 city2))))
	...
	(n2  n1  (:goal (and (at person4 city2))))
